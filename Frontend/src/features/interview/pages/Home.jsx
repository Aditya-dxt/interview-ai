            ...
            <div className="upload-section">
              ...
              {fileName && (
                <div className="file-selected">
                  ...
                  <span>{fileName}</span>
                  <button onClick={() => { setFileName(''); resumeInputRef.current.value = ''; }}>✕</button>
                </div>
              )}
            </div>
          ...
          <ul className="reports-list">
            {reports.map((report) => (
              ...
              >
                ...
                {report.aiProvider && (
                  <span className={`provider-badge provider-badge--${report.aiProvider}`}>
                    {report.aiProvider === 'gemini' ? '✦ Gemini' : report.aiProvider === 'openai' ? '◈ GPT' : '⚡ Local'}
                  </span>
                )}
              </li>
            ))}
